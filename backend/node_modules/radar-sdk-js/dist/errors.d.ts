...
export declare class RadarLocationPermissionsError extends RadarError {
    constructor(message: string);
}
export declare class RadarDesktopAppError extends RadarError {
    constructor();
}
...
export declare class RadarTimeoutError extends RadarError {
    constructor();
}
